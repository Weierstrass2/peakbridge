...
api_v1_router.include_router(grid.router, prefix="/grid", tags=["grid"])
api_v1_router.include_router(vpp.router, prefix="/vpp", tags=["vpp"])
api_v1_router.include_router(dr.router, prefix="/dr", tags=["dr"])
api_v1_router.include_router(state.router, prefix="/state", tags=["state"])

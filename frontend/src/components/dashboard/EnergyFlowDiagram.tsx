      ...
      <div className="flex flex-col items-center gap-6 py-4">
        ...
        <svg viewBox="0 0 800 350" className="w-full max-w-4xl">
          ...
          <g className="cursor-pointer" filter={!isPeakActive ? "url(#glow-blue)" : ""}>
            ...
            <text x="110" y="150" textAnchor="middle" fill={isPeakActive ? "#94A3B8" : "#3B82F6"} fontSize="20" fontWeight="700">{(data.grid_current ?? 0).toFixed(1)}A</text>
          </g>
          ...
          <g className="cursor-pointer">
            ...
            <text x="490" y="150" textAnchor="middle" fill="#A78BFA" fontSize="20" fontWeight="700">{(chargerTotal ?? 0).toFixed(1)}A</text>

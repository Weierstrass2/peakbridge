...
const navItems = [
  ...
  { to: '/chargers', label: 'Chargers', icon: 'M13 10V3L4 14h7v7l9-11h-7z' },
  { to: '/control', label: 'Control', icon: 'M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4' },
  { to: '/hardware', label: '하드웨어 실측', icon: 'M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 7h10v10H7V7zm2 2h6v6H9V9z' },
  ...
  { to: '/energy', label: '에너지 거래', icon: 'M13 10V3L4 14h7v7l9-11h-7z' },
  { to: '/vpp', label: 'VPP 관제', icon: 'M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
